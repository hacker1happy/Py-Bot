...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "Py-BOT")
        # setting botmaster
        ...
        self.setBotPredicate("master","Priyanshu_Gupta")
        self.setBotPredicate("birthplace","Dehradun")
        self.setBotPredicate("location","Dehradun")
        ...
        self.setBotPredicate("state","Uttrakhand")
