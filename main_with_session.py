...
GREETING = ['Hello! My name is Py-bot. I will try my best to provide you information related to our College!']
...
DEFAULT_RESPONSES = ["I did not get you! Pardon please!","I couldn't understand what you just said! Kindly rephrase"
                     ...
                     " queries regrading GEHU, your attendance and grades" ]
        ...
        if(len(inp.split(" "))==1):
            if(isKeyword(inp)==False):
                ...
                if(PWD_REQ==1):
                    ...
                    PWD_REQ = 0
                    return "I'll now be able to answer your course related queries if your credentials are valid! Otherwise you will have to provide your credentials again!"
